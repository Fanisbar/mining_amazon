...
This project is implemented in Python using Jupyter notebooks and is organized into two main parts, corresponding to the two analytical phases of the study:

\section{Part 1: Sentiment Analysis \& EDA}

\subsection{Introduction to Part 1}
The objective of this section is to analyze the relationship between user ratings and the textual content of reviews. We utilize Natural Language Processing (NLP) techniques to compute sentiment scores and correlate them with the star ratings.
